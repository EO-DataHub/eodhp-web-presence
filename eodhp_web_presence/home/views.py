...
This view is intended to be used to generate temporary credentials for a user
to access their associated S3 access point.

To complete this we need to ensure that we can
retrieve the following from the users session:
- username
- access_point_arn
...
def get_temp_credentials(request):
    ...
    # Attaching the username to the session name to make it auditable
    session_name = f"WorkspaceSession-{username}"
    ...
    try:
        ...
        assumed_role = sts_client.assume_role(
            ...
            # TODO: We need to allow role permissions to extend longer than 3600
